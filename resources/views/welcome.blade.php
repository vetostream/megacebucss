...
<body>
		...
		<div class="parallax-container">
			<div class="parallax"><img src="{{ asset('images/04.jpg') }}"></div>
		</div>
		...
		<div class="parallax-container">
			<div class="parallax"><img src="{{ asset('images/05.png') }}"></div>
		</div>
		<div class="section white">
			<div class="row container">
		...
		<div class="parallax-container">
			<div class="parallax"><img src="{{ asset('/images/06.png') }}"></div>
		</div>
